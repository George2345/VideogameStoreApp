...
public class GameDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        addVideogame (db, "F1 2021",R.drawable.f1_2021_cover,59.99, "PS4", "2021-05-31" , "Codemasters","F1 2021 es el videojuego oficial de las temporadas 2021 de Fórmula 1 y del Campeonato de Fórmula 2 de la FIA desarrollado por Codemasters y distribuido por Electronic Arts bajo la división EA Sports. Será lanzado el 16 de julio de 2021 para Microsoft Windows, PlayStation 4, PlayStation 5, Xbox One y Xbox Series X/S.", 0);
