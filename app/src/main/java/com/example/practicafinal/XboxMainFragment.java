...
public class XboxMainFragment extends ListFragment {

    public XboxMainFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor = db.rawQuery(" SELECT _id, NAME, PRICE FROM GAMES WHERE PLATFORM='Xbox' LIMIT 3", null);
    ...
    public void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        {
            SQLiteDatabase db = gameDbHelper.getReadableDatabase();
            Cursor cursor = db.rawQuery(" SELECT _id FROM GAMES WHERE PLATFORM='Xbox' LIMIT 3", null);
