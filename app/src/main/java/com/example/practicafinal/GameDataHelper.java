...
public class GameDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        addVideogame (db, "Fifa 21",R.drawable.fifa,21.55, "PS4", "2020-10-05" , "Electronic Arts","FIFA 21 es un videojuego de fútbol del año 2020 disponible para Microsoft Windows, PlayStation 4, Xbox One y Nintendo Switch el 9 de octubre de 2020, y también es el primer videojuego de la serie FIFA para PlayStation 5 y Xbox Series X|S. El juego es la 28.ª entrega de la serie de videojuegos de FIFA.");

        addVideogame (db, "Assassin's Creed Valhalla",R.drawable.assasinscreed_cover,35.99, "Xbox", "2020-11-10", "Ubisoft Montreal","Assassin's Creed Valhalla es un videojuego desarrollado por Ubisoft Montreal y publicado por Ubisoft. Es el decimosegundo en importancia y el vigesimosegundo lanzado dentro de la saga de Assassin Creed, y sucesor al juego del 2018 Assassin's Creed Odyssey.");
        addVideogame (db, "Biomutant",R.drawable.biomutant_cover,59.99, "Xbox", "2021-05-25" , "Experiment 101" ,"Biomutant es un videojuego perteneciente al género de acción y rol desarrollado por el estudio sueco desarrollador Experiment 101, y publicado por la empresa THQ Nordic. Se lanzó el 25 de mayo de 2021 para Microsoft Windows, PlayStation 4 y Xbox One.");
